  ...
  return (
    <>
      ...
      >
        ...
        <a href="/admin/high-impact-autopilot" style={{ ...linkStyle, background: "#ffdc85", color: "#3e3212", fontWeight: 900 }}>High-Impact Autopilot</a>
        <a href="/admin/high-impact" style={{ ...linkStyle, background: "#d9b6ff", color: "#3f2358", fontWeight: 900 }}>Detailed Accelerator</a>
        ...
        <a href="/admin/system-health" style={{ ...linkStyle, background: "#d8dde2", color: "#22303a" }}>System Health</a>
      </nav>
    </>
  );
}
