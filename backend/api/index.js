...
app.get("/", (_req, res) => res.json({ service: "Mabrig PublishAI Backend", version: serviceVersion, ok: true }));
...
app.get("/api/health", async (_req, res) => {
  ...
  try {
    ...
    res.json({ ok: true, service: "Mabrig PublishAI Backend", version: serviceVersion, database: "connected", latencyMs: Date.now() - started });
  } catch (error) {
